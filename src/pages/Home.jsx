        ...
        <div className="container-custom" style={{ paddingTop:0, paddingBottom:0 }}>
          <motion.div initial="hidden" whileInView="visible" viewport={VP} variants={fUp} transition={{ duration:0.5 }}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4">
              ...
              <StatCell value={50}     label="Products Listed"         sub="Dossiers Prepared"            color="var(--primary)" />
              <StatCell value="< 1 hr" label="Enquiry Turnaround"      sub="Direct Institutional Desk"   color="var(--tertiary)" />
